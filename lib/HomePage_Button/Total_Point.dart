...
class Total_Point extends StatefulWidget {
  const Total_Point({Key? key}) : super(key: key);

  @override
  State<Total_Point> createState() => _Total_PointState();
}

class _Total_PointState extends State<Total_Point> {

  Widget currentScreen = Total_Point();
